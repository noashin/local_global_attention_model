...
from src.LocalChoiceModel.model import Model as model
...
def main(yml_file, output_path):
    ...
    s_0_ob.set_init_value(s_0_config['value'])
    ...
    model_ob = model(saliencies, s_0_ob, b_ob, eps_ob, xi_ob, cov_ratio)
